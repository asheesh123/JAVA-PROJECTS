...
public class ThirdStage extends Frame implements ActionListener,ItemListener
{
	TextArea ta;
	...
	Button b1;
	SecondStage p;
	public ThirdStage(SecondStage p1) 
	{
		setLayout(null);
		p=p1;
	...
	public void actionPerformed(ActionEvent ae)
	{
		if(b1==ae.getSource())
		{
			FourthStage s=new FourthStage(this);
			s.setSize(800,700);
			s.setVisible(true);
			s.setTitle("Fourth Stage");
