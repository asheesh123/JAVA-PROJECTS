...
public class FifthStage extends Frame implements ActionListener,ItemListener
{
	TextArea ta;
	...
	Button b1;
	FourthStage p;
	public FifthStage(FourthStage p1)
	{
		setLayout(null);
		p=p1;
		...
		ta.append("\n        1           3             5             7 \n\n\n");
		ta.append("       9           11           13           15 \n\n\n");
		ta.append("      17           19           21           23 \n\n\n");
		ta.append("      25           27           29           31 ");
	...
	public void actionPerformed(ActionEvent ae)
	{
		if(b1==ae.getSource())
		{
			FinalStage s=new FinalStage(this);
			s.setSize(800,700);
			s.setVisible(true);
			s.setTitle("Final Stage");
