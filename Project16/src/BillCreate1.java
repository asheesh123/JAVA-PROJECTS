...
public class BillCreate1 extends Frame implements FocusListener
{
	...
	public BillCreate1() 
	{
		...
		taa=new TextArea("Item                              Quantity                         Amount\n",10,400);
		add(l);
	...
	{
		BillCreate1 bl=new BillCreate1();
	...
	public void focusGained(FocusEvent fe) 
	{
		if(ta==fe.getSource())
		{
			...
			{
				taa.append(l1.getText()+"                                   "+t1.getText()+"                                 "+t11.getText()+"\n");
			}
			if(Integer.parseInt(t2.getText())!=0)
			{
				taa.append(l2.getText()+"                                  "+t2.getText()+"                                 "+t22.getText()+"\n");
			}
			if(Integer.parseInt(t3.getText())!=0)
			{
				taa.append(l3.getText()+"                                  "+t3.getText()+"                                 "+t33.getText()+"\n");
			}
			if(Integer.parseInt(t4.getText())!=0)
			{
				taa.append(l4.getText()+"                             "+t4.getText()+"                                 "+t44.getText()+"\n");
			}
			if(Integer.parseInt(t5.getText())!=0)
			{
				taa.append(l5.getText()+"                                 "+t5.getText()+"                                 "+t55.getText()+"\n");
			}
			if(Integer.parseInt(t6.getText())!=0)
			{
				taa.append(l6.getText()+"                                 "+t6.getText()+"                                 "+t66.getText()+"\n");
			}
			if(Integer.parseInt(t7.getText())!=0)
			{
				taa.append(l7.getText()+"                                  "+t7.getText()+"                                 "+t77.getText()+"\n");
			}
			if(Integer.parseInt(t8.getText())!=0)
			{
				taa.append(l8.getText()+"                              "+t8.getText()+"                                 "+t88.getText()+"\n");
			}
			if(Integer.parseInt(t9.getText())!=0)
			{
				taa.append(l9.getText()+"                                     "+t9.getText()+"                                 "+t99.getText()+"\n");
			}
			if(Integer.parseInt(t10.getText())!=0)
			{
				taa.append(l10.getText()+"                                  "+t10.getText()+"                                 "+t1010.getText()+"\n");
			}
		}
	}
