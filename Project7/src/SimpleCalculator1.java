...
public class SimpleCalculator1 extends Frame implements ActionListener
{
	TextField t1;
	TextArea t;
	Label l;
	...
	{
		SimpleCalculator1 s=new SimpleCalculator1();
		s.setSize(800,600);
		s.setVisible(true);
	...
	public void actionPerformed(ActionEvent ae) 
	{
		...
		if(be==ae.getSource())
		{
			...
			t.append("\n");
			t.append("result:          "+Float.toString(st1.peek()));
		}
		if(bc==ae.getSource())
		{
			t.setText("");
